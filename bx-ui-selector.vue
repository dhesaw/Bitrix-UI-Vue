<template>
<div class="ui-selector-item-box" :class="{'ui-selector-item-box-selected':isActive}">
    <div class="ui-selector-item">
        <div class="ui-selector-item-avatar" :style="{'background-color':'#979faa', 'background-image': 'url('+imagePresset+')'}"></div>
        <div class="ui-selector-item-titles">
            <div class="ui-selector-item-supertitle"></div>
            <div class="ui-selector-item-title-box">
                <div class="ui-selector-item-title">{{ label }}</div>
                <div class="ui-selector-item-badges">{{ badges }}</div>
                <div class="ui-selector-item-caption">{{ caption }}</div>
            </div>
            <div class="ui-selector-item-subtitle"></div>
        </div>
        <div v-if="isActive" class="ui-selector-item-indicator"></div>
    </div>
</div>
</template>
...
const imagePresset=computed(()=>{
    if (props.image==null || props.image=="") return "data:image/svg+xml;base64,";
