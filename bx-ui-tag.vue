...
<div class="ui-tag-selector-item ui-tag-selector-tag ui-tag-selector-tag--has-avatar">
    <a class="ui-tag-selector-tag-content">
        <div v-if="image!=null" class="ui-tag-selector-tag-avatar" :style="{'background-color':'#979faa', 'background-image': 'url('+image+')'}"></div>
        <div class="ui-tag-selector-tag-title">{{ label }}</div>
    </a>
    <div v-if="actionFn!=null"  @click.prevent="actionFn" class="ui-tag-selector-tag-remove"></div>
</div>
</template>
