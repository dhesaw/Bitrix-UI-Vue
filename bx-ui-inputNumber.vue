<template>
  ...
  watch(()=>model.value, (newValue) => {
    if (props.max!=null && Number(newValue)>Number(props.max)) model.value=Number(props.max);
    else if (props.min!=null && Number(newValue)<Number(props.min)) model.value=Number(props.min);
  })
